  ...
  (function() {
    ...
    TrelloProfile = (function() {
      function TrelloProfile(config) {
        this.config = config;
        this.hydrateTimer = __bind(this.hydrateTimer, this);
        this.addTimer = __bind(this.addTimer, this);
        this.addTimerIfOnCard = __bind(this.addTimerIfOnCard, this);
      ...
      TrelloProfile.prototype.infect = function() {
        ...
        injectScript({
          src: "//" + this.config.subdomain + this.config.domain + "/assets/platform.js",
          async: true
        });
      ...
      TrelloProfile.prototype.addTimerIfOnCard = function() {
        var c, cardId, _, _ref;
        _ref = window.location.pathname.split("/"), _ = _ref[0], c = _ref[1], cardId = _ref[2];
        if (!(c === "c" && (cardId != null))) {
          return;
        }
      ...
      TrelloProfile.prototype.whenReadyForTimer = function(callback) {
        ...
        return interval = window.setInterval(poll, 200);
      };
      ...
      TrelloProfile.prototype.buildTimer = function() {
        ...
        this.timer.className = "disabled button-link js-add-trello-timer";
      ...
      TrelloProfile.prototype.hydrateTimer = function(board, card) {
        this.timer.setAttribute("data-project", JSON.stringify(board));
